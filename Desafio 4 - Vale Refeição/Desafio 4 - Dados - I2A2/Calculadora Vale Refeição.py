...
class VRCalculator:
    ...
    def carregar_planilhas(self, caminho_base='.'):
        ...
        for nome, arquivo in arquivos.items():
            try:
                ...
                if caminho.exists():
                    self.planilhas[nome] = pd.read_excel(caminho) # PLANILHAS É UM DICIONÁRIO
    ...
    def calcular_dias_uteis_matricula(self, matricula, data_admissao=None, sindicato=None):
        ...
        if sindicato and 'RJ' in str(sindicato).upper():
            ...
            estado = 'SP'
        elif sindicato and 'PR' in str(sindicato).upper():
            estado = 'PR'
        elif sindicato and 'RS' in str(sindicato).upper():
            estado = 'RS' 
        ...
        if not self.planilhas['desligamentos'].empty:
            #print('Planilha desligados: ',self.planilhas['desligamentos'])
    ...
    def processar_calculos(self):
        ...
        #print('Todas as matrículas: ', todas_matriculas)
...
def main():
    ...
    resultado = calc.processar_calculos() # RETORNO DO MÉTODO COM PROBLEMA
