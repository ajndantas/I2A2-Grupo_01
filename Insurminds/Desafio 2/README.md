...
* **Rede e Segurança:**
  * Suporte a SSL.
* **CI/CD:** Pipeline automatizado (GitHub Actions) que realiza o build da imagem para a GHCR e executa o deploy na CloudRun. ([YAML](https://github.com/ajndantas/I2A2-Grupo_01/blob/master/.github/workflows/docker-image-agente_chatbotseguro.yml))
